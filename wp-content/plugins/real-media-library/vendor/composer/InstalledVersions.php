...
use MatthiasWeb\RealMediaLibrary\Vendor\Composer\Autoload\ClassLoader;
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        ...
        if (self::$canGetVendors) {
            foreach (\MatthiasWeb\RealMediaLibrary\Vendor\Composer\Autoload\ClassLoader::getRegisteredLoaders() as $vendorDir => $loader) {
