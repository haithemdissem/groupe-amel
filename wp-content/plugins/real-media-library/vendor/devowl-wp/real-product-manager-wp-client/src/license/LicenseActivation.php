...
class LicenseActivation {
    ...
    public function skip($noUsage = \false) {
        ...
        update_option(
            \MatthiasWeb\RealMediaLibrary\Vendor\DevOwl\RealProductManagerWpClient\license\License::OPTION_NAME_INSTALLATION_TYPE_PREFIX .
                $slug,
            \MatthiasWeb\RealMediaLibrary\Vendor\DevOwl\RealProductManagerWpClient\license\License::INSTALLATION_TYPE_PRODUCTION
        );
        update_option(
            \MatthiasWeb\RealMediaLibrary\Vendor\DevOwl\RealProductManagerWpClient\license\License::OPTION_NAME_NO_USAGE_PREFIX .
                $slug,
            $noUsage
        );
        $result = update_option(
            \MatthiasWeb\RealMediaLibrary\Vendor\DevOwl\RealProductManagerWpClient\license\License::OPTION_NAME_CODE_PREFIX .
                $slug,
            ''
        );
        $license->restore();
    ...
    public function activate($code, $installationType, $telemetry, $newsletterOptIn, $firstName, $email) {
        ...
        if (!empty($this->getCode())) {
            ...
            if (!is_wp_error($result)) {
                ...
                update_option(
                    \MatthiasWeb\RealMediaLibrary\Vendor\DevOwl\RealProductManagerWpClient\license\License::OPTION_NAME_HOST_NAME .
                        $slug,
                    \base64_encode(
                ...
                delete_option(
                    \MatthiasWeb\RealMediaLibrary\Vendor\DevOwl\RealProductManagerWpClient\license\License::OPTION_NAME_HINT_PREFIX .
                        $slug
                );
                ...
                if ($initiator->isExternalUpdateEnabled()) {
                    update_option(
                        \MatthiasWeb\RealMediaLibrary\Vendor\DevOwl\RealProductManagerWpClient\view\PluginUpdateView::OPTION_NAME_ADMIN_NOTICE_LICENSE_DISMISSED_DAY_PREFIX .
                 ...
                 */
                do_action(
                    'DevOwl/RealProductManager/LicenseActivation/StatusChanged/' . $slug,
                    \true,
                    $licenseKey,
                    $uuid
                );
