...
class Assets {
    ...
    public function enqueue_scripts_and_styles($type, $hook_suffix = null) {
        ...
        \array_unshift(
            $scriptDeps,
            \MatthiasWeb\RealMediaLibrary\Vendor\DevOwl\RealProductManagerWpClient\Core::getInstance()
                ->getAssets()
                ->enqueue($this)
        );
    ...
    public function overrideLocalizeScript($context) {
        ...
        $isDevLicense =
            ...
            \MatthiasWeb\RealMediaLibrary\Vendor\DevOwl\RealProductManagerWpClient\license\License::INSTALLATION_TYPE_DEVELOPMENT;
    ...
    public function plugin_row_meta($links, $file) {
        if (\false !== \strpos($file, plugin_basename(RML_FILE))) {
            $links[] =
                ...
                esc_attr(__('https://devowl.io/', RML_TD)) .
                '"><strong>' .
