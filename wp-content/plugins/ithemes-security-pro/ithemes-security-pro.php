...
if ( version_compare( phpversion(), '7.0.0', '<' ) ) {
	function itsec_minimum_php_version_notice() {
		echo '<div class="notice notice-error"><p>' . esc_html__( 'iThemes Security Pro requires PHP 7.0 or higher.', 'it-l10n-ithemes-security-pro' ) . '</p></div>';
	}
...
if ( version_compare( $GLOBALS['wp_version'], '5.8', '<' ) ) {
	function itsec_minimum_wp_version_notice() {
		echo '<div class="notice notice-error"><p>' . esc_html__( 'iThemes Security Pro requires WordPress 5.8 or later.', 'it-l10n-ithemes-security-pro' ) . '</p></div>';
	}
